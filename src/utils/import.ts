...
// Convert OpenAI chat format to DevinChatGPT format
export const convertOpenAIToDevinChatGPTFormat = (
...
// Import OpenAI chat data and convert it to DevinChatGPT format
export const importOpenAIChatExport = (openAIChatExport: OpenAIChat[]) => {
  return openAIChatExport.map(convertOpenAIToDevinChatGPTFormat);
};
