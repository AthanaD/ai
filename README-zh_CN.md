...
<p align="center">
    <a href="https://athanad.github.io/ai/">进入网站</a>
    ·
...
要开始使用，只需访问我们的网站：<https://athanad.github.io/ai/>。您有 3 种方法可以开始使用 Devin ChatGPT。

1. 在 API 菜单中输入您从 [OpenAI API Keys](https://platform.openai.com/account/api-keys) 获得的 OpenAI API 密钥。
2. 使用提供的 API 端点代理：[AthanaD/ChatGPTAPIFree](https://github.com/Athanad/ChatGPTAPIFree)。（如果您所在的区域无法访问 ChatGPT）
